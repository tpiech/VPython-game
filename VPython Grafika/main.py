...
def choose_variant():
    ...
    global Shelves
    if v == 1:
        Can.append(Pin(15,0,-40,5,4))
        Can.append(Pin(15,0,-20,5,4))
        Can.append(Pin(15,0,0,5,4))
        Can.append(Pin(15,0,20,5,4))
        Can.append(Pin(15,0,40,5,4))
    elif v == 2:
        Can.append(Pin(45,30,-40,5,4))
        Shelves.append(box( pos = vector(45,30,-40),height = 0.01,length = 10,width = 10))
        Can.append(Pin(30,20,-20,5,4))
